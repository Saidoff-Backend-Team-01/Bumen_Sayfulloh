...
from .models import Category, SubjectTitle, Subject, UserSubject, Vacancy, Step, Club, UserClub, ClubMeetings, StepLesson, StepTest, TestQuestion, TestAnswer, UserTestResult, UserTotalResult
...
class StepTestAdmin(admin.ModelAdmin):
    list_display_fields = ['step', 'ball_for_each_test', 'question_count', 'question_type', 'step_test_type', 'time_for_question']
