...
class Subject(models.Model):
    ...
    subject_type = models.CharField(
        _("Subject type"), max_length=255, choices=SUBJECT_TYPE_CHOICES, default="local"
    )
...
class StepTest(models.Model):
    ...
    question_type = models.CharField(
        max_length=255, choices=QUESTION_TYPE_CHOICES, default="single"
    )
    step_test_type = models.CharField(
        max_length=255, choices=STEP_TEST_TYPE_CHOICES, default="midterm"
    )
...
class TestQuestion(models.Model):
    steptest = models.ForeignKey(
        StepTest, on_delete=models.SET_NULL, null=True, blank=True
    )
...
class TestAnswer(models.Model):
    test_question = models.ForeignKey(
        TestQuestion, on_delete=models.SET_NULL, null=True, blank=True
    )
...
class UserTestResult(models.Model):
    ...
    test_answer = models.ForeignKey(
        TestAnswer, on_delete=models.SET_NULL, null=True, blank=True
    )
